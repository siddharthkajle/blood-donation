...
<script>if(temp==1){setTimeout(function(){window.location.href="index3.php?email="+email},3000);}</script>
<script>if(temp==2){setTimeout(function(){window.location.href='admin.php'},3000);}</script>
</head>
<body>
