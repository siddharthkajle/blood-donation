...
$result=mysqli_fetch_assoc($cost);
    ...
    echo "<table border='1px' cellspacing='2px' cellpadding='7px' align ='center' height='auto' width='50%' bgcolor='#D0A9F5' style=' opacity: 0.6;font-size:28px; '>     <th>S.no. </th>
           <th>Name </th>
           <th>Email </th>
           <th>Number </th><th>Age </th><th>Slot </th><th>Blood </th><th>Image </th>
    ";
    $i=0;
        foreach($cost as $row){
        	  $i++;
             ...
             "<td align='center'>".$row['number']."</td>".
              ...
              "<td align='center'>".$row['blood']."</td>".
              "<td align='center'><img src='".$row['image']."' height='100px' width='100px'></td>".
              "</tr>" ;
